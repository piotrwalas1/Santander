...
public class Tc4asercja1 {
   ...
   driver.findElement(By.xpath("/html/body/div[4]/div/div/div/ul/li[1]/div/a")).click();
     ...
     driver.findElement(By.id("ordinarypin"));
        Thread.sleep(1500);
        WebElement asercja1 = driver.findElement(By.xpath("/html/body/div[5]/main/div[2]/div[1]/div[1]/div/form/div[2]/div[1]/div[2]/span/ul/li/span"));
        Assert.assertEquals("Pole wymagane.", asercja1.getText());
